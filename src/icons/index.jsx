...
const Home = () => {
    return (
        <svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg" className='icon' >
...
const Liked = () => {
    return (
        <svg role="img" height="12" width="12" viewBox="0 0 16 16" className='heart'>
            <path fill="none" d="M0 0h16v16H0z"></path>
...
export { Spotify, Home, Search, Library, Create, Liked }